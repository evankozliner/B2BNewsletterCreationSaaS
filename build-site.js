...
const pages = [
    ...
    },
    {
        ...
        data: {
            title: 'Done-for-You B2B Newsletter Service for Busy Teams | Potions',
            description: 'Get a done-for-you B2B newsletter service and platform that nurtures your old leads into sales conversations.',
            keywords: 'B2B Newsletter, B2B Email Marketing, Lead Nurturing, Sales Newsletter, B2B Content Marketing, Done-for-You Newsletter',
            author: 'Potions',
            baseUrl: '',
            styleSheet: 'style.css',
            additionalCSS: [],
